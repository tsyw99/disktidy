...
pub struct CancellableFileClassifier {
    options: FileClassificationOptions,
    cancelled: Arc<AtomicBool>,
}

impl CancellableFileClassifier {
    pub fn new() -> Self {
        Self {
    ...
    pub fn with_options_and_flag(options: FileClassificationOptions, flag: Arc<AtomicBool>) -> Self {
        Self {
            options,
            cancelled: flag,
        }
...
impl Default for CancellableFileClassifier {
    fn default() -> Self {
        Self::new()
    }
}
